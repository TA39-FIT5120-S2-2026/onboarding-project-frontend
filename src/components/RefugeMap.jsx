...
function createLocationDivIcon() {
  return L.divIcon({
    ...
    html: `<span style="display:block;width:20px;height:20px;transform:rotate(45deg);background:${ACCENT};border-radius:4px 4px 4px 0;box-shadow:0 1px 3px rgba(0,0,0,.35)"></span>`,
    iconSize: [20, 20],
    iconAnchor: [10, 20],
  });
}
